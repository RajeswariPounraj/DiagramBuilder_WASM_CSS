    ...
    Breadcrumb.prototype.renderItems = function (items) {
      ...
      if (itemsLength) {
        ...
        for (var i = 0; i < len; i % 2 && j_1++, i++) {
          ...
          sf.base.append(sf.lists.ListBase.createList(this.createElement, item, listBaseOptions, isSingleLevel, this).childNodes, parent_1);
